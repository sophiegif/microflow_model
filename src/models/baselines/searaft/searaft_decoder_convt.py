...
class SeaRAFTDecoderConvt(
    ...
    def __init__(self, args):
        ...
        self.flow_head1 = nn.Sequential(
            ...
            nn.ReLU(inplace=True),
            nn.Conv2d(intermediate_dim1, 2, 3, padding=1)
        )

        self.upsampled_flow_8_to_4 = nn.ConvTranspose2d(2, 2, 4, 2, 1, bias=False)
        self.upsampled_flow_4_to_2 = nn.ConvTranspose2d(2, 2, 4, 2, 1, bias=False)
        self.upsampled_flow_2_to_1 = nn.ConvTranspose2d(2, 2, 4, 2, 1, bias=False)
    ...
    def upsample_multiscale(self, flow_and_info8, out_conv_8, out_conv_4, out_conv_2):
        ...
        flow_and_info8_up    = self.upsampled_flow_8_to_4(flow8)  # 32, 2, 64, 64
        ...
        flow_and_info4_up    = self.upsampled_flow_4_to_2(flow4)  # 32, 2, 128, 128
        ...
        flow_and_info2_up = self.upsampled_flow_2_to_1(flow2)  # 32, 2, 256, 256
